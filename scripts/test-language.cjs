...
(async () => {
  ...
  try {
    ...
    assert.equal(await evaluate('document.querySelector(".language-toggle").textContent'), "EN");
    assert.equal(await evaluate('document.querySelector(".language-toggle .fi").classList.contains("fi-gb")'), true);
    ...
    assert.equal(await evaluate('document.querySelector(".language-toggle").textContent'), "VI");
    assert.equal(await evaluate('document.querySelector(".language-toggle .fi").classList.contains("fi-vn")'), true);
